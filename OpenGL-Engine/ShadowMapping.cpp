...
int main()
{
    ...
    // shader
    Shader depthShader("shadowMappingDepthVS.glsl", "shadowMappingDepthFS.glsl");
    Shader debugDepthQuad("debug_quad_depthVS.glsl", "debug_quad_depthFS.glsl");
    Shader shadowShader("shadowMappingVS.glsl", "shadowMappingFS.glsl");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // 如果用透视矩阵，记得更改对应的fragment shader
